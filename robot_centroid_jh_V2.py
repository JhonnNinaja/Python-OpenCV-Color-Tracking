...
cont=0#contador para reconocer color
...
while True:
    ...
    try:
        ...
        cv.circle(frame, (cX_r, cY_r), 5, (255, 255, 255), -1)
        cv.putText(frame, "centroid red", (cX_r - 25, cY_r - 25),cv.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 255), 2)
    ...
    try:
        ...
        # put text and highlight the center
        cv.circle(frame, (cX_g, cY_g), 5, (255, 255, 255), -1)
        cv.putText(frame, "centroid green", (cX_g - 25, cY_g - 25),cv.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
